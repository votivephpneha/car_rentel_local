...
class CustomerController extends Controller
{
    ...
    public function add_business_user(Request $request)
    {
      $data['countries'] = DB::table('country')->orderby('name', 'ASC')->get();
      return view('admin/customer/add_business')->with($data);
    }
    ...
    public function add_business_action(Request $request)
    {
        $fname = $request->fname;
        $email = $request->email;
        $user_country = $request->user_country;
    ...
    public function edit_business(Request $request){
        ...
        $data['user_info'] = User::find($user_id);
        $countries = DB::select('select * from country');
        return view('admin/customer/edit_business',["countries"=>$countries])->with($data) ;
    }
    ...
    public function business_update(Request $request){
        ...
        if($res){
            return response()->json(['status' => 'success', 'msg' => 'Business has been updated successfully.']);
            // session::flash('message', 'User updated succesfully.');
            // return redirect('admin/customer_management');
        }else{
            return response()->json(['status' => 'error', 'msg' => 'OOPs! Some internal issue occured.']);
    ...
    public function change_business_status(Request $request)
    {
        ...
        return response()->json(['success'=>'Business status change successfully.']);
    }
    ...
    public function deletebusiness(Request $request) {
        ...
        if ($res) {
            return json_encode(array('status' => 'success','msg' => 'Business has been deleted successfully!'));
        } else {
            return json_encode(array('status' => 'error','msg' => 'Some internal issue occured.'));
        }
