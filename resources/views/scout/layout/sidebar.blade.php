  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ url('/vendor/profile') }}" class="d-block">John Dow Vendor</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item">
            <a href="{{ url('/vendor/scoutList') }}" class="nav-link">
              <i class="nav-icon fas fa-tasks"></i>
              <p>
                Scout List
              </p>
          ...
          <li class="nav-item">
            <a href="{{ url('/vendor/serviceProviderList') }}" class="nav-link">
              <i class="nav-icon fas fa-tasks"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="{{ url('/vendor/customer_management') }}" class="nav-link">
              <i class="nav-icon fas fa-tasks"></i>
              <p>
                Customer List
              </p>
