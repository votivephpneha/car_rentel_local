          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">{{ $profile_detail[0]->name ?? 'Admin' }}</h3>
              ...
              <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="settings">
                        <form class="form-horizontal" method="POST" id="serproProfileUpdate_form" name="serproProfileUpdate_form">
