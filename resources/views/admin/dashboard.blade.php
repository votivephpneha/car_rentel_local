            ...
            <form method="POST" id="dateSearchFilter">
              <div class="row">
                ...
                <div class="submit_btn">
                  <input type="button" name="btn" class="search_btn" value="Search" onclick="searchFilter()">
                </div>
              </div>
            </form>
         ...
         <!-- <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <div class="inner">
                <?php
                  $booking_data_accepted = DB::table("booking_management")->where("booking_status","3")->get();
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="{{ url('/admin/customer_management') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
