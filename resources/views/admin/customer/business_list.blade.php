...
<script>
  ...
  $('.toggle-class').on('change', function() {
    ...
    $.ajax({
      ...
      url: "<?php echo url('/admin/change_business_status'); ?>",
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"><a href="{{ url('/admin/add_business_user') }}"
                                                ...
                                                <tr id="row{{ $arr->id }}">
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/admin/edit_business')}}/{{$arr->id}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
