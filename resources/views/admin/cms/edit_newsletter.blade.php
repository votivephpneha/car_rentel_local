...
$("#newsletterUpdateAdmin_form").validate({
  debug: false,
  rules: {
    pagetitle: {
        required: true,
  ...
  submitHandler: function (form) {
    ...
    $(form).ajaxSubmit({
      type: 'POST',
      url: site_url + '/admin/newsletter_update',
      data: formData,
      success: function (response) {
        ...
        if (response.status == 'success') {
          ...
          setTimeout(function(){window.location.href=site_url+"/admin/newsletter"},1000);
        } else {
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-header">
            ...
            <h3 class="card-title">Newsletter Form</h3>
          ...
          <div class="card-body">
              ...
              <form  method="POST" action="{{url('admin/newsletter_update')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="subtitle" value="{{(!empty($page_info->sub_title) ? $page_info->sub_title : '')}}">
