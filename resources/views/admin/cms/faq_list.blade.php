...
<script>
  ...
  $('.toggle-class').on('change', function() {
    ...
    $.ajax({
      ...
      url: "<?php echo url('/admin/change_faq_status'); ?>",
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Faq</a></li>
                                                ...
                                                <tr id="row{{ $arr->id }}">
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/admin/edit_faq')}}/{{$arr->id}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
