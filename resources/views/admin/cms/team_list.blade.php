...
<script>
  ...
  $('.toggle-class').on('change', function() {
    ...
    $.ajax({
      ...
      url: "<?php echo url('/admin/change_team_status'); ?>",
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Team</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-md-11" style=""><a href="{{ url('/admin/our_team') }}" class="btn btn-block btn-dark w-25">Update Team Title</a></div>

                        <div class="col-md-1" style="margin-bottom: 5px;"><a href="{{ url('/admin/add_team') }}" class="btn btn-block btn-dark">Add</a></div>
                                                ...
                                                <tr id="row{{ $arr->id }}">
                                                    ...
                                                    <td class="text-right py-0 align-middle">
                                                        ...
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="{{url('/admin/edit_team')}}/{{$arr->id}}" class="btn btn-info" style="margin-right: 3px;"><i class="fas fa-pencil-alt"></i></a>
