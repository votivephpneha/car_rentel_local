...
<li class="nav-header">Home Landing</li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('/admin/our_plan') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Our Plan</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ url('/admin/help_notification') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Help Notification</p>
                </a>
              </li>
          ...
          <li class="nav-item"> 
            <a href="{{ url('/admin/content_management') }}" class="nav-link">
              <i class="nav-icon fas fa-tasks"></i>
              <p>
                CMS
              </p>
