      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-header">
            ...
            <h3 class="card-title">Add menus Form</h3>
          ...
          <div class="card-body">
              ...
              <form  method="POST" action="{{url('admin/add_menus')}}">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="menus" id="menus" placeholder="Enter menus">
