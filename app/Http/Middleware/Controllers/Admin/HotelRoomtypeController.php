...
{
    public function hotelRoomType_list() 
    {
    ...
    public function editHotelRoomType(Request $request){
    ...
    public function updateHotelRoomType(Request $request){
    ...
    public function changeHotelRoomTypeStatus(Request $request)
    {
    ...
    public function deleteHotelRoomType(Request $request) {
