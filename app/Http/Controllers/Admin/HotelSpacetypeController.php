...
class HotelSpacetypeController extends Controller
{
    public function hotelSpaceType_list() 
    {
    ...
    public function addHotelSpacetype(Request $request)
    {
      $data['countries'] = DB::table('country')->orderby('name', 'ASC')->get();
      return view('admin/customer/add_customer')->with($data);
    }

    public function submitHotelSpacetype(Request $request)
    {
        $fname = $request->fname;
        $email = $request->email;
    ...
    public function editHotelSpacetype(Request $request){
    ...
    public function updateHotelSpacetype(Request $request){
    ...
    public function changeHotelSpacetypeStatus(Request $request)
    {
    ...
    public function deleteHotelSpacetype(Request $request) {
